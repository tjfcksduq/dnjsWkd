...
<head>
<meta charset="UTF-8">
<title>flowControl.jsp</title>
</head>
<body>
<h4>흐름제어(페이지 이동)</h4>
<pre>
	1. Request Dispatch : 원본 요청에 대한 정보를 페이지에 이동하는 과정에서 전달해주는 방식
...
// 			rd.forward(request, response);			
		...
		2) Include : 페이지를 이동한 후 도착지에서 생성된 결과데이터(버퍼의 내용)을 가지고 출발지(시작페이지)로 다시 돌아오는 구조
...
// 			rd.include(request, response);
	...
	2. Redirect :
		...
		3) 클라이언트 쪽에서 Location 방향으로 새로운 요청이 발생
